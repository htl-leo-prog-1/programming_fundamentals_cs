...
Decode4ColorBands(band1, band2, band3, band4, out double resistorValue, out double tolerance);
...
void Decode4ColorBands(string band1, string band2, string band3, string band4, out double resistorValue, out double tolerance)
{
